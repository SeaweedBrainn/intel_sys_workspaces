...
def generate_launch_description():
    ...
    # NOTE:CHANGE FROM OFFICIAL PACKAGE
    static_tf = Node(
    package='tf2_ros',
    executable='static_transform_publisher',
    name='lidar_reorient',
    arguments=['--x', '0', '--y', '0', '--z', '0',
               '--roll', '-1.5708', '--pitch', '0', '--yaw', '0.392',
               '--frame-id', 'unilidar_lidar', '--child-frame-id', 'world']
)
    return LaunchDescription([node1, rviz_node, static_tf])